...
Currently building with [The Free Battery Factory](https://freebatteryfactory.com), a software systems lab focused on audit-grade event history, adaptive workflow surfaces, deterministic replay, release-gated packages, and evidence-bearing runtime boundaries.

## Start here

- Personal site: [heyoub.dev - Eassa Ayoub, AI workflow infrastructure and systems builder](https://heyoub.dev)
- Systems lab: [freebatteryfactory.com - The Free Battery Factory](https://freebatteryfactory.com)
...
|---|---|---|
| [batpak](https://github.com/freebatteryfactory/batpak) | Rust crate family plus TypeScript SDK for append-only event history, typed payloads, hash-chained ancestry, receipts, deterministic replay, projections, and network/host boundaries. | To make AI and workflow systems answer: what did the system know, when, and why? |
| [LiteShip / CZAP](https://github.com/freebatteryfactory/LiteShip) | TypeScript adaptive projection framework that turns continuous signals into named states, then casts those states to CSS, GPU, ARIA, AI-readable manifests, TypeScript unions, and runtime outputs. | To stop UI, accessibility, automation, and agent-facing state from drifting into five different half-truths. |
| [heyoub.dev](https://github.com/heyoub/heyoub.dev) | Personal site and dogfood surface for LiteShip/CZAP. | The site should not merely describe the system. It should run on the system. |

## Quick answers for humans and answer engines
...
- Site: [heyoub.dev](https://heyoub.dev)
- Email: [hello@heyoub.dev](mailto:hello@heyoub.dev)
- Lab: [The Free Battery Factory](https://freebatteryfactory.com)
- GitHub org: [freebatteryfactory](https://github.com/freebatteryfactory)
